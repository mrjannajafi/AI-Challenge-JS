...
console.log(letterCount(`zahra zanjani `));
*/

// 🟢🟡🟠🔴🔵🟣
// چالش 8: فیلتر کردن آرایه بر اساس شرط
// یک تابع بنویسید که یک آرایه از اعداد را بگیرد و فقط اعداد زوج را برگرداند. از حلقه  و شرط  استفاده کنید.
...
const evenNumber = function (arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] % 2 === 0) {
      numberEven.push(arr[i])
    }
  }
 return numberEven 
}
console.log(evenNumber([2, 4,7 ,87 , 103 ,236]));
*/
